...
Revision ID: 24978be1920d
Revises:
Create Date: 2023-03-16 14:07:03.712196
...
def upgrade():
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE server SET SCHEMA {SCHEMA};") #note singular server!
