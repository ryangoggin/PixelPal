...
Revision ID: 209e6e40a421
Revises:
Create Date: 2023-04-28 12:45:26.333269
...
def upgrade():
    ...
    sa.Column('timestamp', sa.String(length=500), nullable=False), #changed this
    sa.Column('user_id', sa.Integer(), nullable=False),
